...
import es.VetUp.banco_back.b_domain.service.impl.*;
...
import es.VetUp.banco_back.c_persistence.repository.BankAccountRepositoryImpl;
...
public class SpringConfig {
    ...
    @Bean
    public BankTransactionRepository bankTransactionRepository(BankTransactionJpaDao bankTransactionJpaDao) {
        return new BankTransactionRepositoryImpl(bankTransactionJpaDao);
    }
