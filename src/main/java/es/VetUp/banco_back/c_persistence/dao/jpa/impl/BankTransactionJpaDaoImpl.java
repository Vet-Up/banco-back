...
public class BankTransactionJpaDaoImpl implements BankTransactionJpaDao {
    ...
    @Override
    public BankTransactionJpaEntity save(BankTransactionJpaEntity bankTransactionJpaEntity) {
        if (bankTransactionJpaEntity.getTransactionId() == null) {
            entityManager.persist(bankTransactionJpaEntity);
            return bankTransactionJpaEntity;
        } else {
            return entityManager.merge(bankTransactionJpaEntity);
        }
    }
}
